...
function NextSlide(SlideNo) {
    ...
    document.querySelector("scroller").style.marginLeft = parseInt (
        window
...
function MoveIndicationBar(i) {
    var step = document.querySelector(".steps")[i - 1];
...
GlobalSlideNo -= 1;
document.querySelector("scroller").style.amrginLeft =  parseInt(
    window
      .getComputedStyle(document.querySelector("scroller"))
      .getPropertyValue("margin-left")
  ) +
